...
trait Utils
{
     ...
     */
    function utils_clean_content($content)
    {
     ...
     */
    function utils_replace_strange_strings($strIn)
    {
     ...
     */
    // function utils_change_url_protocol($strIn)
    // {
    //     if (strrpos($strIn, '/wp-content/uploads/') !== false) {
    //         $strIn = str_replace('http://', 'https://', $strIn);
    //         $strOut = str_replace(
    //             esd_BE__BasicData::$static_assets,
    //             $this->route_statics_there,
    //             $strIn
    //         );
    //         return $strOut;
    //     } else {
     ...
     * Returns the post_type from a postID
     */
    function utils_get_post_type($pId)
    {
