...
const SingleLinkEditor = ({ attributes, setAttributes }) => {
  ...
  return [
    <div className="single_link">
      ...
      <RichText placeholder="Escribe el title" value={attributes.title} onChange={changeTitleHandler} />
      <RichText placeholder="Escribe el link" value={attributes.link} onChange={changeLinkHandler} />
      <p>
        <small>Este link se meterá en el set de links de descargas al final de cada sección.</small>
      </p>
    </div>,
  ];
};
